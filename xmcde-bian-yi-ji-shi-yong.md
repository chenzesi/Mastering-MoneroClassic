...
![](/assets/gui-wallet1.png)为加快区块同步速度，可以直接连接网络中的节点，目前可以用的节点有:**193.112.64.213**   **111.230.177.177**   **111.231.207.225**    **118.24.41.27**   **123.206.77.55**![](/assets/gui-wallet2.png)
